    ...
    private function seedVietnameseElectronics(): void
    {
        $products = [
            [
                ...
                'slug' => Str::slug('Samsung Galaxy S24 Ultra 512GB'),
                'price' => 33990000,
                'stock' => rand(10, 50),
                'category_slug' => 'smartphones-tablets',
                'brand_name' => 'Samsung',
                'description' => 'Siêu phẩm Galaxy S24 Ultra 512GB với khung viền Titanium bền bỉ, camera 200MP siêu nét và tích hợp Galaxy AI.',
            ...
            [
                ...
                'slug' => Str::slug('Samsung Galaxy Z Fold5 256GB'),
                'price' => 38990000,
                'stock' => rand(10, 50),
                'category_slug' => 'smartphones-tablets',
                'brand_name' => 'Samsung',
            ...
            [
                ...
                'slug' => Str::slug('Đồng hồ Samsung Galaxy Watch 6 Classic'),
                'price' => 8990000,
                'stock' => rand(10, 50),
            ...
            [
                ...
                'slug' => Str::slug('Laptop Dell XPS 15 9530'),
                'price' => 69990000,
                'stock' => rand(10, 50),
                'category_slug' => 'laptops-computers',
                'brand_name' => 'Dell',
                'description' => 'Kiệt tác laptop cao cấp từ Dell với vi xử lý Intel Core i7 thế hệ 13th, màn hình OLED sắc nét, thiết kế vỏ nhôm sang trọng.',
            ...
            [
                ...
                'slug' => Str::slug('Chuột không dây Logitech MX Master 3S'),
                'price' => 2490000,
                'stock' => rand(10, 50),
                'category_slug' => 'peripherals',
                'brand_name' => 'Logitech',
                'description' => 'Chuột công thái học đỉnh cao của Logitech, cảm biến 8000 DPI siêu nhạy trên mọi mặt phẳng kể cả kính.',
            ...
            [
                ...
                'slug' => Str::slug('Tai nghe AirPods Pro Gen 2 (Type-C)'),
                'price' => 6190000,
                'stock' => rand(10, 50),
            ...
            [
                ...
                'slug' => Str::slug('Loa Bluetooth Marshall Stanmore 3'),
                'price' => 10990000,
                'stock' => rand(10, 50),
                'category_slug' => 'audio-speakers',
                'brand_name' => 'Marshall',
                'description' => 'Loa để bàn công suất mạnh mẽ mang đậm phong cách vintage của Marshall, kết nối Bluetooth 5.2 tiên tiến.',
            ...
            [
                ...
                'slug' => Str::slug('Đồng hồ Garmin Fenix 7 Pro'),
                'price' => 22990000,
                'stock' => rand(10, 50),
                'category_slug' => 'wearables-smartwatches',
                'brand_name' => 'Garmin',
                'description' => 'Siêu phẩm đồng hồ thể thao chuyên nghiệp với thấu kính sạc năng lượng mặt trời (Solar).',
            ...
            [
                ...
                'slug' => Str::slug('Bàn phím cơ Akko 3098B Multi-modes'),
                'price' => 2190000,
                'stock' => rand(10, 50),
                'category_slug' => 'peripherals',
                'brand_name' => 'Akko',
                'description' => 'Bàn phím cơ đa kết nối (Bluetooth 5.0, 2.4Ghz, Type-C) với keycap PBT chất lượng.',
            ...
            [
                ...
                'slug' => Str::slug('Sạc dự phòng Anker PowerCore 20000mAh'),
                'price' => 1290000,
                'stock' => rand(10, 50),
            ...
            [
                ...
                'slug' => Str::slug('Màn hình LG 27UP850N-W 27 inch 4K'),
                'price' => 9590000,
                'stock' => rand(10, 50),
                'category_slug' => 'peripherals',
                'brand_name' => 'LG',
    ...
    private function seedElectronicsFromDummyJson(): int
    {
        ...
        foreach ($apiCategories as $dummyCat => $localSlug) {
            ...
            if (!$category) {
                $category = Category::firstOrCreate(
                    ['slug' => $localSlug],
                    ['name' => ucwords(str_replace('-', ' ', $localSlug)), 'description' => 'Danh mục sản phẩm', 'status' => true]
                );
            }
